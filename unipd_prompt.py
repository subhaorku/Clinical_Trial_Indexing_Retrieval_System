...
On a scale of 0 to 10, how relevant is this document to the query? Just reply with a number:"""
    ...
    try:
        ...
        score_str = response.strip().split()[0]  # Extract first number-like word
...
# Initialize the BM25 retriever
    ...
    with open(f"Run_1_NLS_RETRIEVAL_unipd_prompt.txt", 'w') as txt_file:
        txt_file.write("\n".join(text_lines) + "\n")

    with open(f"Run_1_NLS_RETRIEVAL_unipd_prompt.json", 'w') as json_file:
